...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-[var(--color-primary)] text-white py-20">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    } px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]`}
                ...
                {officeLocations.map((office, index) => (
                  ...
                  >
                    ...
                    <div className="space-y-2 text-gray-600">
                      ...
                      <p className="flex items-center">
                        <FaPhone className="mr-2 text-[var(--color-primary)]" />
                        {office.phone}
                      </p>
                      <p className="flex items-center">
            ...
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="text-[var(--color-primary)] hover:text-[var(--color-text-primary)] transition-colors duration-300"
                >
